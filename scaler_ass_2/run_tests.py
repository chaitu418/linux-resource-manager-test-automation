#!/usr/bin/env python3
"""
Test runner for the Linux Process Resource Manager assignment.
...
def main():
    parser = argparse.ArgumentParser(description="Run tests for the Linux Process Resource Manager")
    parser.add_argument(
        "test_type",
        nargs="?",
        default="all",
